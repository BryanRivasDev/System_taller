            ...
            <table id="activeTable">
                <thead>
                    <tr>
                        ...
                        <th class="sortable" onclick="sortTable(2, 'activeTable')">Fecha <i class="ph ph-caret-up-down"></i></th>
            ...
            <table id="historyTable">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="sortable" onclick="sortTable(1, 'historyTable')">Fecha <i class="ph ph-caret-up-down"></i></th>
