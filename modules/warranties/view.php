...
$page_title = 'Detalle de Garantía ' . get_order_number($order);
    ...
    <div class="view-container">
        ...
        <div class="no-print" style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 2rem;">
            <div>
                ...
                <h1 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 0.25rem;">Caso <?php echo get_order_number($order); ?></h1>
            ...
            <div>
                ...
                <script>
                    ...
                    function deleteDiagImage(imgId) {
                        ...
                        window.location.href = '../services/delete_diag_img.php?img_id=' + imgId + '&order_id=<?php echo $id; ?>&type=warranty';
                    }
                </script>
                <?php endif; ?>
                            ...
                            <select name="status" id="statusSelect" class="modern-select">
                                ...
                                <?php endforeach; ?>
                                    ...
                                    <div id="repairModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 1000; justify-content: center; align-items: center;">
                                        <div style="background: var(--p-bg-card); padding: 2rem; border-radius: 16px; width: 90%; max-width: 600px; max-height: 90vh; overflow-y: auto; border: 1px solid var(--p-border);">
                                            <h2 style="margin-top: 0; color: var(--p-primary); margin-bottom: 1.5rem;">Gestión de Reparación (Garantía)</h2>
